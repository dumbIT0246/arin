document.getElementById("loveIn").onclick = function() {if(fungsiAwal==0){audio.play();fungsiAwal=1;loveIn.style="transition:all .8s ease;transform:scale(15);opacity:0";ftAwal.style="opacity:0";wallpaper.style="transform: scale(1.5);";ket.style="display:none";setTimeout(initengahan,300);setTimeout(inipesan,400)}}
  ...
  function kethalo(){new TypeIt("#halo", {strings: ["" + vketikhalo], startDelay: 100, speed: 100, waitUntilVisible: true, afterComplete: function(){halo.innerHTML = vketikhalo;setTimeout(mulaiketik1,200);},}).go();}
  ...
  new TypeIt("#kalimat", {
  strings: ["" + vketik1], startDelay: 100, speed: 100, cursor: false, deleteSpeed: 20, breakLines: false, waitUntilVisible: true, lifelike: true,
  ...
  new TypeIt("#kalimat", {
  strings: ["" + vketik1b], startDelay: 100, speed: 100, cursor: false, deleteSpeed: 20, breakLines: false, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
  ...
  new TypeIt("#kalimat", {
  strings: ["" + vketik2], startDelay: 100, speed: 100, cursor: true, deleteSpeed: 50, breakLines: false, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
  ...
  new TypeIt("#pesan3", {
  strings: ["" + vketik3], startDelay: 100, speed: 100, cursor: true, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
  ...
  function aktipesan7(){
    wallpaper.style="transform: scale(1.5);";
    new TypeIt("#pesan7", {
      strings: ["" + vketik7], startDelay: 100, speed: 100, cursor: false, waitUntilVisible: true,
      afterComplete: function(){
